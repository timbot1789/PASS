...
export const makeHandleFormSubmission = (uploadType, state, dispatch, session, clearInputFields) => {
    ...
    return async (event) => {
        ...
        try {
            ...
            await uploadDocument(session, uploadType, fileObject);
            ...
            try {
                ...
                await updateDocument(session, uploadType, fileObject);
